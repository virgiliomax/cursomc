...
public class CategoriaResource {
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() {
		...
		// Ordena Lista pelo Nome da Categoria - Ascendente
		Collections.sort(listaCategorias, Comparator.comparing((Categoria cats) -> cats.getNome()));
		// Inverte a Ordenação anterior - Descendente
